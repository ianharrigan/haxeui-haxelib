...
{
HX_STACK_FRAME("sys.net._Socket.SocketInput","new",0x5fe92abb,"sys.net._Socket.SocketInput.new","C:\\Servers\\Haxe\\haxe\\std/cpp/_std/sys/net/Socket.hx",31,0xcbfb2d75)
HX_STACK_THIS(this)
HX_STACK_ARG(s,"s")
{
	HX_STACK_LINE(31)
...
int SocketInput_obj::readByte( ){
	HX_STACK_FRAME("sys.net._Socket.SocketInput","readByte",0xee593543,"sys.net._Socket.SocketInput.readByte","C:\\Servers\\Haxe\\haxe\\std/cpp/_std/sys/net/Socket.hx",35,0xcbfb2d75)
	HX_STACK_THIS(this)
	HX_STACK_LINE(35)
	try
	{
...
int SocketInput_obj::readBytes( ::haxe::io::Bytes buf,int pos,int len){
	HX_STACK_FRAME("sys.net._Socket.SocketInput","readBytes",0x9fb565d0,"sys.net._Socket.SocketInput.readBytes","C:\\Servers\\Haxe\\haxe\\std/cpp/_std/sys/net/Socket.hx",47,0xcbfb2d75)
	HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("sys.net._Socket.SocketInput","close",0xbbc7fed3,"sys.net._Socket.SocketInput.close","C:\\Servers\\Haxe\\haxe\\std/cpp/_std/sys/net/Socket.hx",64,0xcbfb2d75)
		HX_STACK_THIS(this)
		HX_STACK_LINE(65)
		this->super::close();
		HX_STACK_LINE(66)
