...
{
HX_STACK_FRAME("sys.net._Socket.SocketOutput","new",0x717472d4,"sys.net._Socket.SocketOutput.new","C:\\Servers\\Haxe\\haxe\\std/cpp/_std/sys/net/Socket.hx",80,0xcbfb2d75)
HX_STACK_THIS(this)
HX_STACK_ARG(s,"s")
{
	HX_STACK_LINE(80)
...
{
		HX_STACK_FRAME("sys.net._Socket.SocketOutput","writeByte",0xbfd704fb,"sys.net._Socket.SocketOutput.writeByte","C:\\Servers\\Haxe\\haxe\\std/cpp/_std/sys/net/Socket.hx",83,0xcbfb2d75)
		HX_STACK_THIS(this)
		HX_STACK_ARG(c,"c")
		HX_STACK_LINE(84)
		if (((this->__s == null()))){
...
int SocketOutput_obj::writeBytes( ::haxe::io::Bytes buf,int pos,int len){
	HX_STACK_FRAME("sys.net._Socket.SocketOutput","writeBytes",0x1c4d5718,"sys.net._Socket.SocketOutput.writeBytes","C:\\Servers\\Haxe\\haxe\\std/cpp/_std/sys/net/Socket.hx",97,0xcbfb2d75)
	HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("sys.net._Socket.SocketOutput","close",0xbcc83f2c,"sys.net._Socket.SocketOutput.close","C:\\Servers\\Haxe\\haxe\\std/cpp/_std/sys/net/Socket.hx",107,0xcbfb2d75)
		HX_STACK_THIS(this)
		HX_STACK_LINE(108)
		this->super::close();
		HX_STACK_LINE(109)
