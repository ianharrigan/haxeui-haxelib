...
Dynamic FileSystem_obj::stat( ::String path){
	HX_STACK_FRAME("sys.FileSystem","stat",0xa630df16,"sys.FileSystem.stat","C:\\Servers\\Haxe\\haxe\\std/cpp/_std/sys/FileSystem.hx",42,0xdf8cd90f)
	...
	if (((s == null()))){
		...
		struct _Function_2_1{
			inline static Dynamic Block( ::Date &_g1,::Date &_g,::Date &_g2){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","C:\\Servers\\Haxe\\haxe\\std/cpp/_std/sys/FileSystem.hx",45,0xdf8cd90f)
				{
...
::String FileSystem_obj::fullPath( ::String relPath){
	HX_STACK_FRAME("sys.FileSystem","fullPath",0xc6463316,"sys.FileSystem.fullPath","C:\\Servers\\Haxe\\haxe\\std/cpp/_std/sys/FileSystem.hx",52,0xdf8cd90f)
...
::sys::_FileSystem::FileKind FileSystem_obj::kind( ::String path){
	HX_STACK_FRAME("sys.FileSystem","kind",0xa0dedc96,"sys.FileSystem.kind","C:\\Servers\\Haxe\\haxe\\std/cpp/_std/sys/FileSystem.hx",56,0xdf8cd90f)
	HX_STACK_ARG(path,"path")
	HX_STACK_LINE(57)
...
bool FileSystem_obj::isDirectory( ::String path){
	HX_STACK_FRAME("sys.FileSystem","isDirectory",0x6c577a21,"sys.FileSystem.isDirectory","C:\\Servers\\Haxe\\haxe\\std/cpp/_std/sys/FileSystem.hx",65,0xdf8cd90f)
	HX_STACK_ARG(path,"path")
	HX_STACK_LINE(66)
...
{
		HX_STACK_FRAME("sys.FileSystem","createDirectory",0x63bad3cf,"sys.FileSystem.createDirectory","C:\\Servers\\Haxe\\haxe\\std/cpp/_std/sys/FileSystem.hx",69,0xdf8cd90f)
		HX_STACK_ARG(path,"path")
		HX_STACK_LINE(70)
			...
			while((true)){
				...
				struct _Function_3_1{
					inline static bool Block( ::String &part){
						HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","C:\\Servers\\Haxe\\haxe\\std/cpp/_std/sys/FileSystem.hx",74,0xdf8cd90f)
						{
							HX_STACK_LINE(74)
...
{
		HX_STACK_FRAME("sys.FileSystem","deleteFile",0x4bd48509,"sys.FileSystem.deleteFile","C:\\Servers\\Haxe\\haxe\\std/cpp/_std/sys/FileSystem.hx",79,0xdf8cd90f)
		HX_STACK_ARG(path,"path")
		HX_STACK_LINE(80)
...
{
		HX_STACK_FRAME("sys.FileSystem","deleteDirectory",0x052a5cc0,"sys.FileSystem.deleteDirectory","C:\\Servers\\Haxe\\haxe\\std/cpp/_std/sys/FileSystem.hx",84,0xdf8cd90f)
		HX_STACK_ARG(path,"path")
		HX_STACK_LINE(85)
...
Array< ::String > FileSystem_obj::readDirectory( ::String path){
	HX_STACK_FRAME("sys.FileSystem","readDirectory",0x0619f8b5,"sys.FileSystem.readDirectory","C:\\Servers\\Haxe\\haxe\\std/cpp/_std/sys/FileSystem.hx",90,0xdf8cd90f)
	HX_STACK_ARG(path,"path")
	HX_STACK_LINE(90)
