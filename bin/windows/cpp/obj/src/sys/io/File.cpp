...
::String File_obj::getContent( ::String path){
	HX_STACK_FRAME("sys.io.File","getContent",0xb28b4a0e,"sys.io.File.getContent","C:\\Servers\\Haxe\\haxe\\std/cpp/_std/sys/io/File.hx",27,0x5c3b519d)
...
::haxe::io::Bytes File_obj::getBytes( ::String path){
	HX_STACK_FRAME("sys.io.File","getBytes",0xbe457600,"sys.io.File.getBytes","C:\\Servers\\Haxe\\haxe\\std/cpp/_std/sys/io/File.hx",32,0x5c3b519d)
	HX_STACK_ARG(path,"path")
	HX_STACK_LINE(33)
...
{
		HX_STACK_FRAME("sys.io.File","saveContent",0xa5557651,"sys.io.File.saveContent","C:\\Servers\\Haxe\\haxe\\std/cpp/_std/sys/io/File.hx",37,0x5c3b519d)
		HX_STACK_ARG(path,"path")
...
{
		HX_STACK_FRAME("sys.io.File","saveBytes",0x6700fb83,"sys.io.File.saveBytes","C:\\Servers\\Haxe\\haxe\\std/cpp/_std/sys/io/File.hx",43,0x5c3b519d)
		HX_STACK_ARG(path,"path")
...
bool binary = __o_binary.Default(true);
	HX_STACK_FRAME("sys.io.File","read",0x203d07e1,"sys.io.File.read","C:\\Servers\\Haxe\\haxe\\std/cpp/_std/sys/io/File.hx",49,0x5c3b519d)
	HX_STACK_ARG(path,"path")
...
bool binary = __o_binary.Default(true);
	HX_STACK_FRAME("sys.io.File","write",0xfec8a9f4,"sys.io.File.write","C:\\Servers\\Haxe\\haxe\\std/cpp/_std/sys/io/File.hx",53,0x5c3b519d)
	HX_STACK_ARG(path,"path")
	HX_STACK_ARG(binary,"binary")
{
		HX_STACK_LINE(54)
