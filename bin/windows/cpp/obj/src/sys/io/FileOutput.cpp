...
{
HX_STACK_FRAME("sys.io.FileOutput","new",0x19e22a16,"sys.io.FileOutput.new","C:\\Servers\\Haxe\\haxe\\std/cpp/_std/sys/io/FileOutput.hx",31,0x6abaaa5c)
HX_STACK_THIS(this)
HX_STACK_ARG(f,"f")
{
	HX_STACK_LINE(31)
...
{
		HX_STACK_FRAME("sys.io.FileOutput","writeByte",0x887099bd,"sys.io.FileOutput.writeByte","C:\\Servers\\Haxe\\haxe\\std/cpp/_std/sys/io/FileOutput.hx",35,0x6abaaa5c)
		HX_STACK_THIS(this)
		HX_STACK_ARG(c,"c")
		HX_STACK_LINE(35)
		try
...
int FileOutput_obj::writeBytes( ::haxe::io::Bytes s,int p,int l){
	HX_STACK_FRAME("sys.io.FileOutput","writeBytes",0xda15ec16,"sys.io.FileOutput.writeBytes","C:\\Servers\\Haxe\\haxe\\std/cpp/_std/sys/io/FileOutput.hx",39,0x6abaaa5c)
	HX_STACK_THIS(this)
	HX_STACK_ARG(s,"s")
	HX_STACK_ARG(p,"p")
	HX_STACK_ARG(l,"l")
...
{
		HX_STACK_FRAME("sys.io.FileOutput","close",0xa583caee,"sys.io.FileOutput.close","C:\\Servers\\Haxe\\haxe\\std/cpp/_std/sys/io/FileOutput.hx",46,0x6abaaa5c)
		HX_STACK_THIS(this)
		HX_STACK_LINE(47)
		this->super::close();
		HX_STACK_LINE(48)
