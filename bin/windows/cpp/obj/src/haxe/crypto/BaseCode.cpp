...
{
HX_STACK_FRAME("haxe.crypto.BaseCode","new",0xd63c60f5,"haxe.crypto.BaseCode.new","C:\\Servers\\Haxe\\haxe\\std/haxe/crypto/BaseCode.hx",33,0xda8bbe3e)
HX_STACK_THIS(this)
...
::haxe::io::Bytes BaseCode_obj::encodeBytes( ::haxe::io::Bytes b){
	HX_STACK_FRAME("haxe.crypto.BaseCode","encodeBytes",0x58a8e40a,"haxe.crypto.BaseCode.encodeBytes","C:\\Servers\\Haxe\\haxe\\std/haxe/crypto/BaseCode.hx",44,0xda8bbe3e)
	HX_STACK_THIS(this)
	HX_STACK_ARG(b,"b")
	HX_STACK_LINE(48)
...
{
		HX_STACK_FRAME("haxe.crypto.BaseCode","initTable",0xa1288133,"haxe.crypto.BaseCode.initTable","C:\\Servers\\Haxe\\haxe\\std/haxe/crypto/BaseCode.hx",72,0xda8bbe3e)
		HX_STACK_THIS(this)
		HX_STACK_LINE(73)
...
::haxe::io::Bytes BaseCode_obj::decodeBytes( ::haxe::io::Bytes b){
	HX_STACK_FRAME("haxe.crypto.BaseCode","decodeBytes",0x152c41f2,"haxe.crypto.BaseCode.decodeBytes","C:\\Servers\\Haxe\\haxe\\std/haxe/crypto/BaseCode.hx",81,0xda8bbe3e)
	HX_STACK_THIS(this)
	HX_STACK_ARG(b,"b")
	HX_STACK_LINE(85)
	int nbits = this->nbits;		HX_STACK_VAR(nbits,"nbits");
