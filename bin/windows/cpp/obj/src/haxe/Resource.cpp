...
::String Resource_obj::getString( ::String name){
	HX_STACK_FRAME("haxe.Resource","getString",0x974269cf,"haxe.Resource.getString","C:\\Servers\\Haxe\\haxe\\std/cpp/_std/haxe/Resource.hx",31,0x03eda9c9)
...
::haxe::io::Bytes Resource_obj::getBytes( ::String name){
	HX_STACK_FRAME("haxe.Resource","getBytes",0x9bc1712d,"haxe.Resource.getBytes","C:\\Servers\\Haxe\\haxe\\std/cpp/_std/haxe/Resource.hx",33,0x03eda9c9)
	HX_STACK_ARG(name,"name")
	HX_STACK_LINE(34)
