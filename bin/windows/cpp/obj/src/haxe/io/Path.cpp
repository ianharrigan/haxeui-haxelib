...
{
HX_STACK_FRAME("haxe.io.Path","new",0x1b96d677,"haxe.io.Path.new","C:\\Servers\\Haxe\\haxe\\std/haxe/io/Path.hx",76,0xe11ccf7c)
HX_STACK_THIS(this)
...
::String Path_obj::directory( ::String path){
	HX_STACK_FRAME("haxe.io.Path","directory",0xbcfe23c4,"haxe.io.Path.directory","C:\\Servers\\Haxe\\haxe\\std/haxe/io/Path.hx",141,0xe11ccf7c)
	HX_STACK_ARG(path,"path")
	HX_STACK_LINE(142)
...
::String Path_obj::addTrailingSlash( ::String path){
	HX_STACK_FRAME("haxe.io.Path","addTrailingSlash",0x8b4f8e69,"haxe.io.Path.addTrailingSlash","C:\\Servers\\Haxe\\haxe\\std/haxe/io/Path.hx",268,0xe11ccf7c)
	HX_STACK_ARG(path,"path")
	HX_STACK_LINE(269)
...
::String Path_obj::removeTrailingSlashes( ::String path){
	HX_STACK_FRAME("haxe.io.Path","removeTrailingSlashes",0x2dc73462,"haxe.io.Path.removeTrailingSlashes","C:\\Servers\\Haxe\\haxe\\std/haxe/io/Path.hx",293,0xe11ccf7c)
	HX_STACK_ARG(path,"path")
	HX_STACK_LINE(294)
	while((true)){
		HX_STACK_LINE(295)
