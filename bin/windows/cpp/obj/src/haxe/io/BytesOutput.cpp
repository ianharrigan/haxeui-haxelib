...
{
HX_STACK_FRAME("haxe.io.BytesOutput","new",0x130b775e,"haxe.io.BytesOutput.new","C:\\Servers\\Haxe\\haxe\\std/haxe/io/BytesOutput.hx",35,0x745c1d8f)
HX_STACK_THIS(this)
{
	HX_STACK_LINE(40)
...
{
		HX_STACK_FRAME("haxe.io.BytesOutput","writeByte",0xed1b0d05,"haxe.io.BytesOutput.writeByte","C:\\Servers\\Haxe\\haxe\\std/haxe/io/BytesOutput.hx",52,0x745c1d8f)
		HX_STACK_THIS(this)
		HX_STACK_ARG(c,"c")
		HX_STACK_LINE(52)
		this->b->b->push(c);
...
int BytesOutput_obj::writeBytes( ::haxe::io::Bytes buf,int pos,int len){
	HX_STACK_FRAME("haxe.io.BytesOutput","writeBytes",0x8a9057ce,"haxe.io.BytesOutput.writeBytes","C:\\Servers\\Haxe\\haxe\\std/haxe/io/BytesOutput.hx",56,0x745c1d8f)
	HX_STACK_THIS(this)
...
::haxe::io::Bytes BytesOutput_obj::getBytes( ){
	HX_STACK_FRAME("haxe.io.BytesOutput","getBytes",0x9fe35837,"haxe.io.BytesOutput.getBytes","C:\\Servers\\Haxe\\haxe\\std/haxe/io/BytesOutput.hx",119,0x745c1d8f)
	HX_STACK_THIS(this)
	HX_STACK_LINE(119)
