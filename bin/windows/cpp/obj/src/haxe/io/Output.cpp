...
{
		HX_STACK_FRAME("haxe.io.Output","writeByte",0xb4fe513a,"haxe.io.Output.writeByte","C:\\Servers\\Haxe\\haxe\\std/haxe/io/Output.hx",39,0xbe90fe60)
		HX_STACK_THIS(this)
		HX_STACK_ARG(c,"c")
		HX_STACK_LINE(39)
...
int Output_obj::writeBytes( ::haxe::io::Bytes s,int pos,int len){
	HX_STACK_FRAME("haxe.io.Output","writeBytes",0xa988c1f9,"haxe.io.Output.writeBytes","C:\\Servers\\Haxe\\haxe\\std/haxe/io/Output.hx",42,0xbe90fe60)
	HX_STACK_THIS(this)
	HX_STACK_ARG(s,"s")
...
{
		HX_STACK_FRAME("haxe.io.Output","close",0xe726bfeb,"haxe.io.Output.close","C:\\Servers\\Haxe\\haxe\\std/haxe/io/Output.hx",68,0xbe90fe60)
		HX_STACK_THIS(this)
	}
return null();
}
...
{
		HX_STACK_FRAME("haxe.io.Output","write",0x6f1d1512,"haxe.io.Output.write","C:\\Servers\\Haxe\\haxe\\std/haxe/io/Output.hx",78,0xbe90fe60)
		HX_STACK_THIS(this)
		HX_STACK_ARG(s,"s")
		HX_STACK_LINE(79)
...
{
		HX_STACK_FRAME("haxe.io.Output","writeFullBytes",0xc2c420ea,"haxe.io.Output.writeFullBytes","C:\\Servers\\Haxe\\haxe\\std/haxe/io/Output.hx",90,0xbe90fe60)
		HX_STACK_THIS(this)
		HX_STACK_ARG(s,"s")
		HX_STACK_ARG(pos,"pos")
		HX_STACK_ARG(len,"len")
...
{
		HX_STACK_FRAME("haxe.io.Output","prepare",0xcd01ec7a,"haxe.io.Output.prepare","C:\\Servers\\Haxe\\haxe\\std/haxe/io/Output.hx",288,0xbe90fe60)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("haxe.io.Output","writeString",0x97e1cb83,"haxe.io.Output.writeString","C:\\Servers\\Haxe\\haxe\\std/haxe/io/Output.hx",313,0xbe90fe60)
		HX_STACK_THIS(this)
		HX_STACK_ARG(s,"s")
		HX_STACK_LINE(317)
