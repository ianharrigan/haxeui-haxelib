...
{
HX_STACK_FRAME("haxe.ds.ObjectMap","new",0x27af5498,"haxe.ds.ObjectMap.new","C:\\Servers\\Haxe\\haxe\\std/cpp/_std/haxe/ds/ObjectMap.hx",29,0x11f5475a)
HX_STACK_THIS(this)
{
	HX_STACK_LINE(30)
...
{
		HX_STACK_FRAME("haxe.ds.ObjectMap","set",0x27b31fda,"haxe.ds.ObjectMap.set","C:\\Servers\\Haxe\\haxe\\std/cpp/_std/haxe/ds/ObjectMap.hx",34,0x11f5475a)
		HX_STACK_THIS(this)
...
Dynamic ObjectMap_obj::get( Dynamic key){
	HX_STACK_FRAME("haxe.ds.ObjectMap","get",0x27aa04ce,"haxe.ds.ObjectMap.get","C:\\Servers\\Haxe\\haxe\\std/cpp/_std/haxe/ds/ObjectMap.hx",40,0x11f5475a)
	HX_STACK_THIS(this)
	HX_STACK_ARG(key,"key")
	HX_STACK_LINE(41)
...
bool ObjectMap_obj::remove( Dynamic key){
	HX_STACK_FRAME("haxe.ds.ObjectMap","remove",0x0d3b8b0c,"haxe.ds.ObjectMap.remove","C:\\Servers\\Haxe\\haxe\\std/cpp/_std/haxe/ds/ObjectMap.hx",48,0x11f5475a)
	HX_STACK_THIS(this)
	HX_STACK_ARG(key,"key")
	HX_STACK_LINE(49)
	int id = ::__hxcpp_obj_id(key);		HX_STACK_VAR(id,"id");
...
Dynamic ObjectMap_obj::keys( ){
	HX_STACK_FRAME("haxe.ds.ObjectMap","keys",0x8fbf0ebc,"haxe.ds.ObjectMap.keys","C:\\Servers\\Haxe\\haxe\\std/cpp/_std/haxe/ds/ObjectMap.hx",55,0x11f5475a)
	HX_STACK_THIS(this)
	HX_STACK_LINE(55)
...
Dynamic ObjectMap_obj::iterator( ){
	HX_STACK_FRAME("haxe.ds.ObjectMap","iterator",0x61fc7ab6,"haxe.ds.ObjectMap.iterator","C:\\Servers\\Haxe\\haxe\\std/cpp/_std/haxe/ds/ObjectMap.hx",59,0x11f5475a)
	HX_STACK_THIS(this)
	HX_STACK_LINE(59)
