...
{
HX_STACK_FRAME("haxe.Http","new",0x57ac51e2,"haxe.Http.new","C:\\Servers\\Haxe\\haxe\\std/haxe/Http.hx",88,0x359cccca)
HX_STACK_THIS(this)
...
::haxe::Http Http_obj::setHeader( ::String header,::String value){
	HX_STACK_FRAME("haxe.Http","setHeader",0x34bd0dd1,"haxe.Http.setHeader","C:\\Servers\\Haxe\\haxe\\std/haxe/Http.hx",110,0x359cccca)
	HX_STACK_THIS(this)
	HX_STACK_ARG(header,"header")
	HX_STACK_ARG(value,"value")
	HX_STACK_LINE(110)
	Array< ::String > header1 = Array_obj< ::String >::__new().Add(header);		HX_STACK_VAR(header1,"header1");

	HX_BEGIN_LOCAL_FUNC_S1(hx::LocalFunc,_Function_1_1,Array< ::String >,header1)
	bool run(Dynamic h){
		HX_STACK_FRAME("*","_Function_1_1",0x5200ed37,"*._Function_1_1","C:\\Servers\\Haxe\\haxe\\std/haxe/Http.hx",111,0x359cccca)
		HX_STACK_ARG(h,"h")
		{
			HX_STACK_LINE(111)
			return (h->__Field(HX_CSTRING("header"),true) != header1->__get((int)0));
		}
		return null();
	}
	...
	HX_STACK_LINE(111)
	::List _g = ::Lambda_obj::filter(this->headers, Dynamic(new _Function_1_1(header1)));		HX_STACK_VAR(_g,"_g");
	HX_STACK_LINE(111)
	this->headers = _g;
	struct _Function_1_2{
		inline static Dynamic Block( Array< ::String > &header1,::String &value){
			HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","C:\\Servers\\Haxe\\haxe\\std/haxe/Http.hx",112,0x359cccca)
			{
				hx::Anon __result = hx::Anon_obj::Create();
				__result->Add(HX_CSTRING("header") , header1->__get((int)0),false);
	...
	HX_STACK_LINE(112)
	this->headers->push(_Function_1_2::Block(header1,value));
	HX_STACK_LINE(113)
...
::haxe::Http Http_obj::setParameter( ::String param,::String value){
	HX_STACK_FRAME("haxe.Http","setParameter",0x96e033e5,"haxe.Http.setParameter","C:\\Servers\\Haxe\\haxe\\std/haxe/Http.hx",128,0x359cccca)
	HX_STACK_THIS(this)
	HX_STACK_ARG(param,"param")
	HX_STACK_ARG(value,"value")
	HX_STACK_LINE(128)
	Array< ::String > param1 = Array_obj< ::String >::__new().Add(param);		HX_STACK_VAR(param1,"param1");

	HX_BEGIN_LOCAL_FUNC_S1(hx::LocalFunc,_Function_1_1,Array< ::String >,param1)
	bool run(Dynamic p){
		HX_STACK_FRAME("*","_Function_1_1",0x5200ed37,"*._Function_1_1","C:\\Servers\\Haxe\\haxe\\std/haxe/Http.hx",129,0x359cccca)
		HX_STACK_ARG(p,"p")
		{
			HX_STACK_LINE(129)
			return (p->__Field(HX_CSTRING("param"),true) != param1->__get((int)0));
		}
		return null();
	}
	HX_END_LOCAL_FUNC1(return)
	...
	HX_STACK_LINE(129)
	::List _g = ::Lambda_obj::filter(this->params, Dynamic(new _Function_1_1(param1)));		HX_STACK_VAR(_g,"_g");
	HX_STACK_LINE(129)
	this->params = _g;
	struct _Function_1_2{
		inline static Dynamic Block( Array< ::String > &param1,::String &value){
			HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","C:\\Servers\\Haxe\\haxe\\std/haxe/Http.hx",130,0x359cccca)
			{
				hx::Anon __result = hx::Anon_obj::Create();
				__result->Add(HX_CSTRING("param") , param1->__get((int)0),false);
				__result->Add(HX_CSTRING("value") , value,false);
				return __result;
			}
			return null();
	...
	HX_STACK_LINE(130)
	this->params->push(_Function_1_2::Block(param1,value));
	HX_STACK_LINE(131)
	return hx::ObjectPtr<OBJ_>(this);
}
...
{
		HX_STACK_FRAME("haxe.Http","request",0xb2c949d1,"haxe.Http.request","C:\\Servers\\Haxe\\haxe\\std/haxe/Http.hx",197,0x359cccca)
		HX_STACK_THIS(this)
		...
		Void run(::String e){
			HX_STACK_FRAME("*","_Function_1_1",0x5200ed37,"*._Function_1_1","C:\\Servers\\Haxe\\haxe\\std/haxe/Http.hx",367,0x359cccca)
			HX_STACK_ARG(e,"e")
			{
				HX_STACK_LINE(371)
...
::String mimeType = __o_mimeType.Default(HX_CSTRING("application/octet-stream"));
	HX_STACK_FRAME("haxe.Http","fileTransfer",0x44285405,"haxe.Http.fileTransfer","C:\\Servers\\Haxe\\haxe\\std/haxe/Http.hx",397,0x359cccca)
	HX_STACK_THIS(this)
	...
	HX_STACK_ARG(mimeType,"mimeType")
{
		struct _Function_1_1{
			inline static Dynamic Block( ::String &mimeType,int &size,::String &filename,::haxe::io::Input &file,::String &argname){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","C:\\Servers\\Haxe\\haxe\\std/haxe/Http.hx",397,0x359cccca)
				{
					hx::Anon __result = hx::Anon_obj::Create();
					...
					__result->Add(HX_CSTRING("mimeType") , mimeType,false);
					return __result;
				}
				return null();
			}
		...
		HX_STACK_LINE(397)
		this->file = _Function_1_1::Block(mimeType,size,filename,file,argname);
	}
return null();
}
...
{
		HX_STACK_FRAME("haxe.Http","customRequest",0x68e97fa0,"haxe.Http.customRequest","C:\\Servers\\Haxe\\haxe\\std/haxe/Http.hx",400,0x359cccca)
		HX_STACK_THIS(this)
		HX_STACK_ARG(post,"post")
...
;
		...
		if (((this->postData != null()))){
			...
			if (((bool(post) && bool((uri != null()))))){
				...
				bool run(Dynamic h){
					HX_STACK_FRAME("*","_Function_3_1",0x520271b9,"*._Function_3_1","C:\\Servers\\Haxe\\haxe\\std/haxe/Http.hx",502,0x359cccca)
					HX_STACK_ARG(h,"h")
					{
						HX_STACK_LINE(502)
...
{
		HX_STACK_FRAME("haxe.Http","readHttpResponse",0x6bff43dd,"haxe.Http.readHttpResponse","C:\\Servers\\Haxe\\haxe\\std/haxe/Http.hx",559,0x359cccca)
		HX_STACK_THIS(this)
		HX_STACK_ARG(api,"api")
		HX_STACK_ARG(sock,"sock")
		HX_STACK_LINE(561)
...
bool Http_obj::readChunk( ::EReg chunk_re,::haxe::io::Output api,::haxe::io::Bytes buf,int len){
	HX_STACK_FRAME("haxe.Http","readChunk",0xeebfa239,"haxe.Http.readChunk","C:\\Servers\\Haxe\\haxe\\std/haxe/Http.hx",699,0x359cccca)
	HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("haxe.Http","onData",0x4f093aa7,"haxe.Http.onData","C:\\Servers\\Haxe\\haxe\\std/haxe/Http.hx",765,0x359cccca)
		HX_STACK_THIS(this)
...
Void run(::String msg){
{
		HX_STACK_FRAME("haxe.Http","onError",0x77abd4ab,"haxe.Http.onError","C:\\Servers\\Haxe\\haxe\\std/haxe/Http.hx",775,0x359cccca)
		HX_STACK_THIS(this)
...
Void run(int status){
{
		HX_STACK_FRAME("haxe.Http","onStatus",0xf341a4ef,"haxe.Http.onStatus","C:\\Servers\\Haxe\\haxe\\std/haxe/Http.hx",785,0x359cccca)
		HX_STACK_THIS(this)
...
::String Http_obj::requestUrl( ::String url){
	HX_STACK_FRAME("haxe.Http","requestUrl",0x3bd0d21e,"haxe.Http.requestUrl","C:\\Servers\\Haxe\\haxe\\std/haxe/Http.hx",797,0x359cccca)
	HX_STACK_ARG(url,"url")
	HX_STACK_LINE(798)
	...
	Void run(::String d){
		HX_STACK_FRAME("*","_Function_1_1",0x5200ed37,"*._Function_1_1","C:\\Servers\\Haxe\\haxe\\std/haxe/Http.hx",804,0x359cccca)
		HX_STACK_ARG(d,"d")
		{
			HX_STACK_LINE(804)
			r[(int)0] = d;
	...
	Void run(::String e){
		HX_STACK_FRAME("*","_Function_1_2",0x5200ed38,"*._Function_1_2","C:\\Servers\\Haxe\\haxe\\std/haxe/Http.hx",807,0x359cccca)
		HX_STACK_ARG(e,"e")
		{
			HX_STACK_LINE(807)
			HX_STACK_DO_THROW(e);
