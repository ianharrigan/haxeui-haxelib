...
::String CallStack_obj::toString( Array< ::Dynamic > stack){
	HX_STACK_FRAME("haxe.CallStack","toString",0xd59be738,"haxe.CallStack.toString","C:\\Servers\\Haxe\\haxe\\std/haxe/CallStack.hx",170,0xabdd6220)
...
{
		HX_STACK_FRAME("haxe.CallStack","itemToString",0xc121696b,"haxe.CallStack.itemToString","C:\\Servers\\Haxe\\haxe\\std/haxe/CallStack.hx",180,0xabdd6220)
		HX_STACK_ARG(b,"b")
		HX_STACK_ARG(s,"s")
		HX_STACK_LINE(180)
