...
{
HX_STACK_FRAME("cpp.vm.Thread","new",0x66262c28,"cpp.vm.Thread.new","C:\\Servers\\Haxe\\haxe\\std/cpp/vm/Thread.hx",31,0x08bd1305)
HX_STACK_THIS(this)
HX_STACK_ARG(h,"h")
{
	HX_STACK_LINE(31)
...
::cpp::vm::Thread Thread_obj::current( ){
	HX_STACK_FRAME("cpp.vm.Thread","current",0x21a37c01,"cpp.vm.Thread.current","C:\\Servers\\Haxe\\haxe\\std/cpp/vm/Thread.hx",45,0x08bd1305)
	HX_STACK_LINE(46)
...
::cpp::vm::Thread Thread_obj::create( Dynamic callb){
	HX_STACK_FRAME("cpp.vm.Thread","create",0xb01a9834,"cpp.vm.Thread.create","C:\\Servers\\Haxe\\haxe\\std/cpp/vm/Thread.hx",52,0x08bd1305)
