...
::String StringTools_obj::urlEncode( ::String s){
	HX_STACK_FRAME("StringTools","urlEncode",0x06afdce1,"StringTools.urlEncode","C:\\Servers\\Haxe\\haxe\\std/StringTools.hx",46,0x58ef71b1)
	HX_STACK_ARG(s,"s")
	HX_STACK_LINE(46)
...
::String StringTools_obj::urlDecode( ::String s){
	HX_STACK_FRAME("StringTools","urlDecode",0x71b947f9,"StringTools.urlDecode","C:\\Servers\\Haxe\\haxe\\std/StringTools.hx",71,0x58ef71b1)
	HX_STACK_ARG(s,"s")
	HX_STACK_LINE(71)
...
::String StringTools_obj::htmlEscape( ::String s,Dynamic quotes){
	HX_STACK_FRAME("StringTools","htmlEscape",0x0e1a5dd0,"StringTools.htmlEscape","C:\\Servers\\Haxe\\haxe\\std/StringTools.hx",97,0x58ef71b1)
	HX_STACK_ARG(s,"s")
...
bool StringTools_obj::startsWith( ::String s,::String start){
	HX_STACK_FRAME("StringTools","startsWith",0x5f4e6efb,"StringTools.startsWith","C:\\Servers\\Haxe\\haxe\\std/StringTools.hx",133,0x58ef71b1)
	HX_STACK_ARG(s,"s")
...
bool StringTools_obj::endsWith( ::String s,::String end){
	HX_STACK_FRAME("StringTools","endsWith",0x0eb5bfe2,"StringTools.endsWith","C:\\Servers\\Haxe\\haxe\\std/StringTools.hx",144,0x58ef71b1)
	HX_STACK_ARG(s,"s")
...
bool StringTools_obj::isSpace( ::String s,int pos){
	HX_STACK_FRAME("StringTools","isSpace",0xe0290778,"StringTools.isSpace","C:\\Servers\\Haxe\\haxe\\std/StringTools.hx",165,0x58ef71b1)
	HX_STACK_ARG(s,"s")
...
::String StringTools_obj::ltrim( ::String s){
	HX_STACK_FRAME("StringTools","ltrim",0x24d2234a,"StringTools.ltrim","C:\\Servers\\Haxe\\haxe\\std/StringTools.hx",179,0x58ef71b1)
	HX_STACK_ARG(s,"s")
	HX_STACK_LINE(183)
...
::String StringTools_obj::rtrim( ::String s){
	HX_STACK_FRAME("StringTools","rtrim",0x99399e50,"StringTools.rtrim","C:\\Servers\\Haxe\\haxe\\std/StringTools.hx",204,0x58ef71b1)
	HX_STACK_ARG(s,"s")
	HX_STACK_LINE(208)
	int l = s.length;		HX_STACK_VAR(l,"l");
	HX_STACK_LINE(209)
...
::String StringTools_obj::trim( ::String s){
	HX_STACK_FRAME("StringTools","trim",0x2908d066,"StringTools.trim","C:\\Servers\\Haxe\\haxe\\std/StringTools.hx",226,0x58ef71b1)
	HX_STACK_ARG(s,"s")
	HX_STACK_LINE(232)
...
::String StringTools_obj::lpad( ::String s,::String c,int l){
	HX_STACK_FRAME("StringTools","lpad",0x23bd8feb,"StringTools.lpad","C:\\Servers\\Haxe\\haxe\\std/StringTools.hx",248,0x58ef71b1)
	HX_STACK_ARG(s,"s")
	HX_STACK_ARG(c,"c")
	HX_STACK_ARG(l,"l")
	HX_STACK_LINE(249)
...
::String StringTools_obj::rpad( ::String s,::String c,int l){
	HX_STACK_FRAME("StringTools","rpad",0x27b4d7a5,"StringTools.rpad","C:\\Servers\\Haxe\\haxe\\std/StringTools.hx",270,0x58ef71b1)
	HX_STACK_ARG(s,"s")
	HX_STACK_ARG(c,"c")
	HX_STACK_ARG(l,"l")
	HX_STACK_LINE(271)
...
::String StringTools_obj::replace( ::String s,::String sub,::String by){
	HX_STACK_FRAME("StringTools","replace",0x6d651f30,"StringTools.replace","C:\\Servers\\Haxe\\haxe\\std/StringTools.hx",303,0x58ef71b1)
	HX_STACK_ARG(s,"s")
...
::String StringTools_obj::hex( int n,Dynamic digits){
	HX_STACK_FRAME("StringTools","hex",0xd91debd7,"StringTools.hex","C:\\Servers\\Haxe\\haxe\\std/StringTools.hx",313,0x58ef71b1)
	HX_STACK_ARG(n,"n")
