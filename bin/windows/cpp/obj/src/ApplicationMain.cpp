...
Void ApplicationMain_obj::main( ){
{
		...
		HX_STACK_LINE(19)
		::openfl::Lib_obj::setPackage(HX_CSTRING(""),HX_CSTRING("haxelib_client"),HX_CSTRING("haxe.ui.haxelib.haxeuihaxelib"),HX_CSTRING("1.0.0"));
		...
		Void run(){
			HX_STACK_FRAME("*","_Function_1_1",0x5200ed37,"*._Function_1_1","ApplicationMain.hx",35,0x0780ded5)
			{
				...
				HX_STACK_LINE(81)
				{
					...
					HX_STACK_LINE(81)
					Array< ::String > _g1 = ::Type_obj::getClassFields(hx::ClassOf< ::haxe::ui::haxelib::Main >());		HX_STACK_VAR(_g1,"_g1");
					HX_STACK_LINE(81)
					while(((_g < _g1->length))){
						HX_STACK_LINE(81)
				...
				if ((hasMain)){
					HX_STACK_LINE(94)
					::Reflect_obj::callMethod(hx::ClassOf< ::haxe::ui::haxelib::Main >(),::Reflect_obj::field(hx::ClassOf< ::haxe::ui::haxelib::Main >(),HX_CSTRING("main")),Dynamic( Array_obj<Dynamic>::__new()));
				}
				else{
					HX_STACK_LINE(98)
		...
		HX_STACK_LINE(35)
		::openfl::Lib_obj::create( Dynamic(new _Function_1_1()),(int)800,(int)600,(int)60,(int)16777215,(int((int((int((int((int((int((int((int((int((int(::openfl::Lib_obj::HARDWARE) | int(::openfl::Lib_obj::ALLOW_SHADERS))) | int((int)0))) | int((int)0))) | int((int)0))) | int(::openfl::Lib_obj::RESIZABLE))) | int((int)0))) | int((int)0))) | int((int)0))) | int((int)0))) | int((int)0)),HX_CSTRING("Haxelib Client"),null(),null());
	}
return null();
}
