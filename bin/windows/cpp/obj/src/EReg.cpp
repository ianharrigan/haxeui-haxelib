...
{
HX_STACK_FRAME("EReg","new",0x8b859e81,"EReg.new","C:\\Servers\\Haxe\\haxe\\std/cpp/_std/EReg.hx",28,0xd4366e6d)
HX_STACK_THIS(this)
HX_STACK_ARG(r,"r")
...
bool EReg_obj::match( ::String s){
	HX_STACK_FRAME("EReg","match",0x18fda1a6,"EReg.match","C:\\Servers\\Haxe\\haxe\\std/cpp/_std/EReg.hx",36,0xd4366e6d)
	HX_STACK_THIS(this)
	HX_STACK_ARG(s,"s")
	HX_STACK_LINE(37)
...
::String EReg_obj::matched( int n){
	HX_STACK_FRAME("EReg","matched",0x8ce62f85,"EReg.matched","C:\\Servers\\Haxe\\haxe\\std/cpp/_std/EReg.hx",45,0xd4366e6d)
	HX_STACK_THIS(this)
	HX_STACK_ARG(n,"n")
	HX_STACK_LINE(46)
...
Dynamic EReg_obj::matchedPos( ){
	HX_STACK_FRAME("EReg","matchedPos",0x7007a70f,"EReg.matchedPos","C:\\Servers\\Haxe\\haxe\\std/cpp/_std/EReg.hx",62,0xd4366e6d)
	HX_STACK_THIS(this)
	HX_STACK_LINE(62)
...
Array< ::String > EReg_obj::split( ::String s){
	HX_STACK_FRAME("EReg","split",0x9749433b,"EReg.split","C:\\Servers\\Haxe\\haxe\\std/cpp/_std/EReg.hx",74,0xd4366e6d)
	HX_STACK_THIS(this)
	HX_STACK_ARG(s,"s")
	HX_STACK_LINE(75)
