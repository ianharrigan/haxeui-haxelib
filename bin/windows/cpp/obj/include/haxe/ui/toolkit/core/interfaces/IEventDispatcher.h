...
#define INCLUDED_haxe_ui_toolkit_core_interfaces_IEventDispatcher
...
#define DELEGATE_haxe_ui_toolkit_core_interfaces_IEventDispatcher \
...
#endif /* INCLUDED_haxe_ui_toolkit_core_interfaces_IEventDispatcher */ 
