...
#define INCLUDED_haxe_ui_toolkit_containers_ContinuousHBox
...
HX_DECLARE_CLASS4(haxe,ui,toolkit,containers,ContinuousHBox)
...
class HXCPP_CLASS_ATTRIBUTES  ContinuousHBox_obj : public ::haxe::ui::toolkit::containers::Container_obj{
	public:
	...
	public:
		...
		::String __ToString() const { return HX_CSTRING("ContinuousHBox"); }
...
#endif /* INCLUDED_haxe_ui_toolkit_containers_ContinuousHBox */ 
