...
#define INCLUDED_haxe_ui_toolkit_controls_CheckBoxValue
...
class HXCPP_CLASS_ATTRIBUTES  CheckBoxValue_obj : public ::haxe::ui::toolkit::controls::Value_obj{
	public:
	...
	public:
		...
		::String __ToString() const { return HX_CSTRING("CheckBoxValue"); }
...
#endif /* INCLUDED_haxe_ui_toolkit_controls_CheckBoxValue */ 
