...
#define INCLUDED_haxe_ui_toolkit_controls_HProgressLayout
...
HX_DECLARE_CLASS4(haxe,ui,toolkit,controls,HProgressLayout)
...
class HXCPP_CLASS_ATTRIBUTES  HProgressLayout_obj : public ::haxe::ui::toolkit::layout::DefaultLayout_obj{
	public:
	...
	public:
		...
		::String __ToString() const { return HX_CSTRING("HProgressLayout"); }
...
#endif /* INCLUDED_haxe_ui_toolkit_controls_HProgressLayout */ 
