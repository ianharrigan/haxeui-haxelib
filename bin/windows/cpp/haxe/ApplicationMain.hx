...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("", "haxelib_client", "haxe.ui.haxelib.haxeuihaxelib", "1.0.0");
		...
		flash.Lib.create (function () {
				...
				for (methodName in Type.getClassFields (haxe.ui.haxelib.Main)) {
				...
				if (hasMain) {
					...
					Reflect.callMethod (haxe.ui.haxelib.Main, Reflect.field (haxe.ui.haxelib.Main, "main"), []);
...
@:keep class DocumentClass extends haxe.ui.haxelib.Main {}
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "Haxelib Client", null, { width: 800, height: 600 });
			...
			if (hasMain) {
				...
				var instance = Type.createInstance (haxe.ui.haxelib.Main, []);
			}
